...
To view a live example, **[click here](http://arsslensoft.com/)**.
...
- Navigate to `package.json` and enter your domain name instead of `http://arsslensoft.com/` in `homepage` variable. For example, if you want your site to be `https://<your-username>.github.io/developerFolio`, add the same to the homepage section of `package.json`.
